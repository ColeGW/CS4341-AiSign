...
from src.entity.artifcat_entity import DataTransformationArtifacts, ModelTrainerArtifacts
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifacts:
        try:
            logging.info("Entered the initial_model_trainer method of Model trainer class")
            ...
            logging.info("SGD optimizer used")
